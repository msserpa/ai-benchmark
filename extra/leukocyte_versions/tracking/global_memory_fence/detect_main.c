...
int main(int argc, char ** argv) {
	...
	// Open video file
	char *video_file_name = "testfiles/testfile.avi";
	...
	if (argc > 1) {
		...
		// Make sure we do not go off the end of the video
		int max_frames = cell_file->video_frames - 1;
	...
	ellipsetrack(cell_file, QAX_CENTERS, QAY_CENTERS, k_count, radius, num_frames);
